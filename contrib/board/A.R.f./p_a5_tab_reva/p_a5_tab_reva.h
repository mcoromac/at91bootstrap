...
#define USART_BASE			(AT91C_BASE_FLEXCOM2 + 0x0200)
#define CONFIG_SYS_DBGU_RXD_PIN		AT91C_PIN_PD(27)
#define CONFIG_SYS_DBGU_TXD_PIN		AT91C_PIN_PD(26)
#define CONFIG_SYS_DBGU_ID		AT91C_ID_FLEXCOM2
